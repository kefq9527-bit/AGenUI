    ...
    private func loadConfigs() {
        ...
        let configString = """
        {
          ...
          "ChoicePicker": {
            ...
            "item-padding-vertical": "20px",
            "radio-size": "40px",
            "radio-border-width": "3px",
            "radio-border-color": "#C5C5C5",
            "radio-border-color-selected": "#2496FF",
            "radio-border-color-disabled": "#C5C5C5",
            "radio-dot-color": "#2496FF",
            "radio-dot-color-disabled": "#8D8D8D",
            "checkbox-size": "40px",
            "checkbox-background-color-selected": "#2496FF",
            "checkbox-border-color-selected": "#2496FF",
            "checkbox-background-color": "#00000000",
            "checkbox-border-color": "#C5C5C5",
            "checkbox-fill-color-disabled": "#8D8D8D",
            "checkbox-border-width": "3px",
            "checkbox-border-radius": "8px",
            "check-color": "#FFFFFF",
            "check-line-width": "4px",
            "text-margin": "16px",
            "text-color": "#191919",
            "text-color-disabled": "#A9A9A9",
            "text-size": "28px",
            "choice-gap": "16px",
          ...
          "MXChoicePicker": {
            ...
            "radio-dot-color-disabled": "#8D8D8D",
            "checkbox-size": "40px",
            "checkbox-corner-radius": "8px",
            "checkbox-border-width": "3px",
            "checkbox-border-color": "#C5C5C5",
            "checkbox-border-color-selected": "#2496FF",
            "checkbox-border-color-disabled": "#C5C5C5",
            "checkbox-fill-color": "#2496FF",
            "checkbox-fill-color-disabled": "#8D8D8D",
            "check-color": "#FFFFFF",
            "check-line-width": "4px"
          },
          "MXPrimaryButton": {
            ...
            "background-color-selected": "#2496FF",
            "text-color": "#EBF5FF",
          ...
          "AudioPlayer": {
            ...
            "ring-width": "8px",
            "play-bg-color": "#2496FF",
            "pause-bg-color": "#FFFFFF",
            "ring-color": "#2496FF",
            "play-icon-color": "#FFFFFF",
            "pause-icon-color": "#2496FF",
            "loading-color": "#2496FF",
