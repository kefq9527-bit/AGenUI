    ...
    private func loadConfigs() {
        ...
        let configString = """
        {
          ...
          "MXPrimaryButton": {
            ...
            "background-color-selected": "#2273F7",
            "text-color": "#EBF5FF",
